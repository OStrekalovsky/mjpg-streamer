...
public class Image {
    ...
    public void setCorners(float x0, float y0, // UL
        ...
        if (corners == null)
            ...
            corners.clear();
        corners.add((Float) x0);
        corners.add((Float) y0);
        corners.add((Float) x1);
        corners.add((Float) y1);
        corners.add((Float) x2);
        corners.add((Float) y2);
        corners.add((Float) x3);
        corners.add((Float) y3);
    }
     ...
     * file extension.
     */
    public void saveAs(String PathToImageFile) throws IOException {
     ...
     * file extension.
     */
    public void saveAs(java.io.File OutputFile) throws IOException {
        ...
        if (outputQuality >= 0f && outputQuality <= 1.2f) {
            ...
            if (useSunCodec) {
                ...
                try {
					 ...
					 * params.setVerticalSubsampling(0,2); encoder.encode(bi,
					 * params);
					 */
                } catch (Exception e) {
                    bas.reset();
